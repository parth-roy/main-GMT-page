export const BASE_URL = import.meta.env.VITE_API_URL || 'https://api.gomytruck.com/api/v1';
...
export async function verifyOtp(phone, otp, intendedRole = 'CUSTOMER', name = '', email = '') {
